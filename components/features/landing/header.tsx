  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full px-6 max-w-7xl mx-auto">
        {/* Brand Logo */}
        <Link href="#" className="flex items-center gap-2 text-2xl font-black tracking-tight text-primary dark:text-white hover:scale-98 transition-all">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-indigo-650 shadow-sm shadow-indigo-200 dark:shadow-none">
            <FileText className="h-5 w-5 text-white" />
          </div>
          <span className="text-xl font-bold tracking-tight text-slate-900 dark:text-white font-headline-lg">
            appFacture
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link
            href="/dashboard"
            className="text-sm font-bold text-slate-650 dark:text-slate-300 hover:text-indigo-650 dark:hover:text-indigo-400 transition-colors px-4 py-2"
          >
            Connexion
          </Link>
          <Link
            href="/dashboard"
            className="cta-primary bg-indigo-600 text-white text-xs font-bold px-6 py-3 rounded-full shadow-md shadow-indigo-150 hover:bg-indigo-750 transition-all"
          >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white dark:bg-slate-900 border-b border-slate-200/80 dark:border-slate-800 p-6 space-y-4 shadow-xl animate-in slide-in-from-top duration-200">
          <nav className="flex flex-col space-y-3">
            ...
            <Link
              href="/dashboard"
              className="text-sm font-bold text-slate-650 dark:text-slate-300 py-2 text-center hover:bg-slate-50 rounded-xl"
            >
              Connexion
            </Link>
            <Link
              href="/dashboard"
              className="w-full text-center bg-indigo-600 text-white text-xs font-bold py-3 rounded-full hover:bg-indigo-750 transition-all shadow-md"
            >
              Commencer gratuitement
            </Link>
          </nav>
